...
class TableAdapter(
    ...
    override fun getItemViewType(position: Int): Int {
        if (!isSettingMode) return TYPE_NORMAL
        return if (items[position] == null) TYPE_ADD else TYPE_SETTING
    }
        ...
        when (holder) {
            is NormalViewHolder -> {
                ...
                holder.binding.apply {
                    ...
                    tvTablePeople.text = ""
                    tvTableState.text = "비어있음"
                    tvTableState.setTextColor(android.graphics.Color.parseColor("#999999"))
